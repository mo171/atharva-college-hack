...
const NAV_ITEMS = [
  { href: "/start-writing", label: "Projects", icon: FolderOpen, isActive: true },
  { href: "/start-writing/shared", label: "Shared", icon: Users, isActive: false },
  { href: "/start-writing/archive", label: "Archive", icon: Archive, isActive: false },
  { href: "/start-writing/settings", label: "Settings", icon: Settings, isActive: false },
];
