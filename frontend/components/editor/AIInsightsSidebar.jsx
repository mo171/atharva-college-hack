...
function InsightCard({ type, subLabel, headerBg, icon: Icon, iconColor, text, primaryAction }) {
  return (
    <div className="overflow-hidden rounded-2xl border border-[#e8e8e0] bg-white shadow-md shadow-black/5">
      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex gap-2">
          ...
          <Button size="sm" className="flex-1 bg-[#ced3ff] text-[#4a4a7a] transition-colors hover:bg-[#b8bff5]">
            {primaryAction}
          </Button>
        </div>
      </div>
